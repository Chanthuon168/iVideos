...
import com.hammersmith.ivideos.adapter.FavoriteAdapter;
...
public class FragmentFavourite extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        if (PrefUtils.getCurrentUser(getActivity()) != null) {
            ...
            Call<List<Video>> callComment = service.getVideoFavorite(video);
            callComment.enqueue(new Callback<List<Video>>() {
                ...
                public void onResponse(Call<List<Video>> call, Response<List<Video>> response) {
                    ...
                    if (videos.size() > 0) {
                        adapter = new FavoriteAdapter(getActivity(), videos);
